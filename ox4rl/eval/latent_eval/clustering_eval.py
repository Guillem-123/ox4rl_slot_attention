import torch
from ox4rl.eval.latent_eval.z_what_eval import ZWhatEvaluator
from ox4rl.eval.latent_eval.prepare_z_what_dataset import ZWhatDataPreparation
import numpy as np
...
class ClusteringEval:
    ...
    def eval_clustering(self, data_subset_modes, dataset_mode):
        ...
        data = ZWhatDataPreparation(self.cfg).collect_and_prepare_z_what_data(self.cfg, dataset_mode, data_subset_modes)
